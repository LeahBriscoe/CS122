...
def hash_read(read, genome_ht):
    ...
    # print "hash score" + str(hash_score)
    # print "read", read
...
def hashing_algorithm(paired_end_reads, genome_ht):
    ...
    count = 0
    start = time.clock()
    print "first size " + str(len(paired_end_reads))
    ...
    # newalignments = filter(None, alignments)
    # newgenome_aligned_reads = filter(None, genome_aligned_reads)
    # print "new size " + str(len(newalignments))
    # print newalignments
    # print newgenome_aligned_reads

    #return newalignments, newgenome_aligned_reads
